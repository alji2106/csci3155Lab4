object Lab4 extends jsy.util.JsyApplication {
  ...
  this.debug = false // comment this out or set to false if you don't want print debugging 
  //information
  ...
  // Interface to run your small-step interpreter and print out the steps of evaluation if 
  //debugging. 
